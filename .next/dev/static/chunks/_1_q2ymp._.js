...
const resolveBaseURL = ()=>{
    ...
    const envURL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.REACT_APP_API_URL;
...
const AuthProvider = ({ children })=>{
        ...
        "AuthProvider.useEffect": ()=>{
            const loadUser = {
                "AuthProvider.useEffect.loadUser": async ()=>{
                    if (token) {
                        try {
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].getProfile();
                            setUser(response.data.data);
                        } catch (error) {
                            console.error('Failed to load user:', error);
                            // Clear invalid token
                            ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.removeItem('token');
                            setToken(null);
                        }
                    }
                    setLoading(false);
    ...
    const login = async (credentials)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].login(credentials);
            const { token: newToken, ...userData } = response.data.data;
            ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.setItem('token', newToken);
            setToken(newToken);
            setUser(userData);
            return {
                success: true,
    ...
    const googleLogin = async (credential)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].googleLogin(credential);
            const { token: newToken, ...userData } = response.data.data;
            ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.setItem('token', newToken);
            setToken(newToken);
            setUser(userData);
    ...
    const register = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].register(userData);
    ...
    const updateProfile = async (data)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].updateProfile(data);
            const { token: newToken, ...userData } = response.data.data;
            if (newToken) {
                ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.setItem('token', newToken);
                setToken(newToken);
...
_s1(AuthProvider, "lxhGgcmcXV6aL9ZVPg4UJQt29jc=");
_c = AuthProvider;
var _c;
...
const saveCart = (userId, items)=>{
    ...
    try {
        ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.setItem(key, JSON.stringify(items));
    } catch  {}
};
const CartProvider = ({ children, userId })=>{
    ...
    const [cart, setCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "CartProvider.useState": ()=>loadCart(userId)
    }["CartProvider.useState"]);
    /* ── When userId changes (login / logout / switch account):
        load the new user's cart and discard the previous one   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    /* ── Persist to localStorage whenever cart or userId changes  */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartProvider.useEffect": ()=>{
    ...
    /* ── Cart actions ─────────────────────────────────── */ const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[addToCart]": (product, quantity = 1)=>{
            ...
            if (!userId) {
                ...
                __turbopack_context__.A("[project]/node_modules/react-hot-toast/dist/index.mjs [app-client] (ecmascript, async loader)").then({
                    "CartProvider.useCallback[addToCart]": ({ default: toast })=>{
                        toast.error({
                            "CartProvider.useCallback[addToCart]": (t)=>{
                                const dismiss = {
                                    "CartProvider.useCallback[addToCart].dismiss": ()=>toast.dismiss(t.id)
                                }["CartProvider.useCallback[addToCart].dismiss"];
            ...
            setCart({
                "CartProvider.useCallback[addToCart]": (prev)=>{
                    ...
                    const exists = prev.find({
                        "CartProvider.useCallback[addToCart].exists": (i)=>(i._id || i.id) === id
                    }["CartProvider.useCallback[addToCart].exists"]);
                    if (exists) {
                        return prev.map({
                            "CartProvider.useCallback[addToCart]": (i)=>(i._id || i.id) === id ? {
                                    ...i,
        ...
        "CartProvider.useCallback[removeFromCart]": (productId)=>{
            setCart({
                "CartProvider.useCallback[removeFromCart]": (prev)=>prev.filter({
                        "CartProvider.useCallback[removeFromCart]": (i)=>(i._id || i.id) !== productId
        ...
        "CartProvider.useCallback[updateQuantity]": (productId, quantity)=>{
            ...
            setCart({
                "CartProvider.useCallback[updateQuantity]": (prev)=>prev.map({
                        "CartProvider.useCallback[updateQuantity]": (i)=>(i._id || i.id) === productId ? {
                                ...i,
                                quantity
                            } : i
    ...
    /* clearCart wipes both state AND localStorage for this user */ const clearCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[clearCart]": ()=>{
            setCart([]);
            const key = cartKey(userId);
            if (key) ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.removeItem(key);
        }
    }["CartProvider.useCallback[clearCart]"], [
        userId
    ]);
    const getCartTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getCartTotal]": ()=>cart.reduce({
                "CartProvider.useCallback[getCartTotal]": (t, i)=>t + i.price * i.quantity
    ...
    const getCartCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getCartCount]": ()=>cart.reduce({
                "CartProvider.useCallback[getCartCount]": (c, i)=>c + i.quantity
...
_s1(CartProvider, "vg2j+1+f5I8eBp0OueqxH7tXNR8=");
_c = CartProvider;
var _c;
...
"[project]/context/CartContextWrapper.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(CartProviderWrapper, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
...
"[project]/context/NotificationContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const saveToStorage = (items)=>{
    try {
        ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.setItem(STORAGE_KEY, JSON.stringify(items.slice(0, MAX_NOTIFS)));
    } catch  {}
};
...
const NotificationProvider = ({ children })=>{
    _s1();
    const [notifications, setNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(loadFromStorage);
    ...
    /* persist on change */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    /* ── add a notification ─────────────────────────── */ const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[addNotification]": (type, title, message, meta = {})=>{
            const notif = {
    ...
    /* ── mark single as read ────────────────────────── */ const markRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[markRead]": (id)=>{
            setNotifications({
                "NotificationProvider.useCallback[markRead]": (prev)=>prev.map({
                        "NotificationProvider.useCallback[markRead]": (n)=>n.id === id ? {
                                ...n,
                                read: true
                            } : n
                    }["NotificationProvider.useCallback[markRead]"])
            }["NotificationProvider.useCallback[markRead]"]);
        }
    }["NotificationProvider.useCallback[markRead]"], []);
    /* ── mark all read ──────────────────────────────── */ const markAllRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[markAllRead]": ()=>{
            setNotifications({
                "NotificationProvider.useCallback[markAllRead]": (prev)=>prev.map({
                        "NotificationProvider.useCallback[markAllRead]": (n)=>({
                                ...n,
                                read: true
                            })
                    }["NotificationProvider.useCallback[markAllRead]"])
    ...
    /* ── clear all ──────────────────────────────────── */ const clearAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[clearAll]": ()=>{
            setNotifications([]);
            ("TURBOPACK compile-time value", "object") !== "undefined" && localStorage.removeItem(STORAGE_KEY);
        }
    }["NotificationProvider.useCallback[clearAll]"], []);
    /* ── register socket (called by SocketContext) ─── */ const registerSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[registerSocket]": (socket, userRole)=>{
            if (socketRef.current === socket) return;
            socketRef.current = socket;
            /* Admin-only events */ if (userRole === 'admin') {
                socket.on('new_order', {
                    "NotificationProvider.useCallback[registerSocket]": (data)=>{
                ...
                }["NotificationProvider.useCallback[registerSocket]"]);
            ...
            /* User-facing events */ socket.on('order_status_updated', {
                "NotificationProvider.useCallback[registerSocket]": (data)=>{
...
_s1(NotificationProvider, "8XIkt9vOkAY1gHMdA/FdPbFDTiU=");
...
"[project]/context/SocketContext.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/NotificationContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
...
const useSocket = ()=>{
    _s();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(SocketContext);
    if (!ctx) throw new Error('useSocket must be used within a SocketProvider');
    return ctx;
};
_s(useSocket, "/dMy7t63NXD4eYACoT93CePwGrg=");
const SocketProvider = ({ children })=>{
    ...
    const { user, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    try {
        const notifCtx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
        ...
        "SocketProvider.useEffect": ()=>{
            ...
            if (token && user) {
                pollingInterval.current = setInterval({
                    "SocketProvider.useEffect": async ()=>{
                        try {
                            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/chat/unread', {
                                headers: {
                ...
                }["SocketProvider.useEffect"], 15000);
            }
            return ({
                "SocketProvider.useEffect": ()=>{
    ...
    const emitEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SocketProvider.useCallback[emitEvent]": (eventName, data, cb)=>{
            console.warn(`Emit event stubbed for polling architecture: ${eventName}`);
            if (cb) cb();
        }
    }["SocketProvider.useCallback[emitEvent]"], []);
    const value = {
        socket: {
            connected: true,
            emit: emitEvent
...
_s1(SocketProvider, "Ev9sS+QJhiW3ZSMFENNYDU0IDxw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/components/common/Header.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* ── Notification Panel ──────────────────────────────── */ const NotificationPanel = ({ onClose })=>{
    _s();
    const { notifications, unreadCount, markRead, markAllRead, clearAll } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: notifications.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 90,
                    columnNumber: 11
                }, ("TURBOPACK compile-time value", void 0)) : notifications.slice(0, 15).map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NotificationPanel, "erbPZCk4X3JQoJUqaV4RC1yT/hY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"]
    ];
});
...
═════════════════════════════════════════════════════ */ const Header = ()=>{
    ...
    const [bellAnimate, setBellAnimate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const { cart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const { user, logout, isAdmin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const { unreadCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    const prevUnread = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(unreadCount);
    const cartItemsCount = cart.reduce((total, item)=>total + item.quantity, 0);
    /* scroll effect */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            const onScroll = {
    ...
    /* bell shake on new notification */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            if (unreadCount > prevUnread.current) {
                setBellAnimate(true);
                setTimeout({
                    "Header.useEffect": ()=>setBellAnimate(false)
                }["Header.useEffect"], 900);
            }
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isNotifOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NotificationPanel, {
...
_s1(Header, "L82GqINbGfEkjPO1UnV9Gf8Y3Qg=", false, function() {
    return [
...
"[project]/components/common/Footer.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/common/ChatWidget.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/SocketContext.jsx [app-client] (ecmascript)");
...
const ChatWidget = ()=>{
    _s();
    const { user, token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { socket, connected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocket"])();
        ...
        "ChatWidget.useEffect": ()=>{
            ...
            socket.on('messageNotification', {
                "ChatWidget.useEffect": (data)=>{
                    if (!isOpen || minimized) {
                        setUnreadCount({
                            "ChatWidget.useEffect": (prev)=>prev + 1
                        }["ChatWidget.useEffect"]);
                    }
                }
            }["ChatWidget.useEffect"]);
    ...
    async function fetchConversation() {
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`\${process.env.REACT_APP_API_URL}/chat/conversation`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
        ...
        if (imageFile) {
            ...
            try {
                ...
                if (uploadResponse.data.data.images && uploadResponse.data.data.images.length > 0) {
                    imageUrl = `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.REACT_APP_BACKEND_URL}${uploadResponse.data.data.images[0].path}`;
                }
            } catch (error) {
                                    ...
                                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        columnNumber: 19
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    msg.imageUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                        src: msg.imageUrl,
                                                        alt: "attachment",
...
_s(ChatWidget, "HRYFKZ15K4fWwUXizxjjpfcYtoU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocket"]
    ];
});
_c = ChatWidget;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/AuthContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContextWrapper$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/CartContextWrapper.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/SocketContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/NotificationContext.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Header$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/common/Header.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Footer$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/common/Footer.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$ChatWidget$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/common/ChatWidget.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function Providers({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$react$2d$oauth$2f$google$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoogleOAuthProvider"], {
        clientId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "mock",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContextWrapper$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CartProviderWrapper"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SocketProvider"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$NotificationContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationProvider"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    !isAdminRoute && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Header$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/components/Providers.jsx",
                                        lineNumber: 34,
                                        columnNumber: 35
                                    }, this),
                                    ...
                                    !isAdminRoute && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Footer$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/components/Providers.jsx",
                                        lineNumber: 38,
                                        columnNumber: 35
                                    }, this),
                                    !isAdminRoute && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$ChatWidget$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                        fileName: "[project]/components/Providers.jsx",
                                        lineNumber: 39,
                                        columnNumber: 35
                                    }, this)
...
//# sourceMappingURL=_1_q2ymp._.js.map